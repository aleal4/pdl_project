...
export declare type IdentifyRequiredParams = RequireAtLeastOne<{
    name: string;
    first_name: string;
    last_name: string;
    location: string;
...
export declare type IdentifyParams = IdentifyRequiredParams & Partial<{
    middle_name: string;
    country: string;
    birth_date: string;
    required: string;
...
//# sourceMappingURL=identify-types.d.ts.map