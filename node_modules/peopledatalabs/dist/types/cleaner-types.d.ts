...
export declare type CleanerType = 'company' | 'school' | 'location';
export declare type CompanyCleanerParams = RequireAtLeastOne<{
    name: string;
    website: string;
    profile: string;
}> & {
...
export declare type SchoolCleanerParams = CompanyCleanerParams;
