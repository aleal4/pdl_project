...
export declare type EnrichmentType = 'company' | 'person';
...
export declare type PersonEnrichmentParams = EnrichmentAdditionalParams & Partial<{
...
export declare type CompanyEnrichmentParams = RequireAtLeastOne<CompanyEnrichmentRequiredParams> & EnrichmentAdditionalParams & {
    location?: string;
    locality?: string;
    region?: string;
    country?: string;
